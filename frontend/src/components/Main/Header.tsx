  ...
  return (
    <header className="flex space-x-4 justify-between items-center">
      ...
      <div className="flex space-x-4">
        ...
        <button type="button" onClick={() => setModalVisible(true)} className="hidden lg:inline-flex relative items-center justify-center p-0.5 h-10 sm:h-11 overflow-hidden text-sm font-bold rounded-lg bg-gradient-to-br from-pink-500 to-orange-400 text-white text-shadow">
      ...
      <button type="button" onClick={() => setModalVisible(true)} className="flex items-center justify-center lg:hidden fixed bottom-5 right-5 bg-red-400 hover:bg-red-500 text-white p-4 rounded-full shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
