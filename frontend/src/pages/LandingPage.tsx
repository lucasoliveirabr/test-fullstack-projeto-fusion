  ...
  return (
    <main className="grid h-screen place-items-center max-w-screen-xl px-4 py-8 mx-2 sm:mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      <div className="lg:col-span-7">
        ...
        <button type="submit" onClick={signIn} className="inline-flex items-center justify-center px-10 sm:px-24 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-900">
          Vamos lá!
